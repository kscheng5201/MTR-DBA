...
class RabbitMQAPI(object):
    ...
    def _send_data(self, file):
        ...
        return_code = 0
        logging.debug("Execute CMD:" + str(args))
...
def main():
    ...
    parser.add_option('--senderhostname', default='10.23.1.151-PROD-RabbitMQ-01', help='Allows including a sender parameter on calls to zabbix_sender')
