...
"""
echo $requestBody
curl -sH "Content-Type: application/json" -X GET http://"elasticsearch-backend-01":9200/gl_user/_count |awk -F '{"count":' '{print $2}' |awk -F ',"_shards' '{print $1}'
